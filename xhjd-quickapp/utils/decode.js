/**
 * 加密：使用decode.getData(str)
 * 解密：使用decode.encryptData(str)
 */
var decode = (function () {
  var KEY = 'SHI0QTBKRlYwNmw1U3FrdHFzRmtoTDlC';
  var getData = function (message) {
    return DES3.decrypt(base64decode(KEY), message)
  };

  var encryptData = function (message) {
    return DES3.encrypt(base64decode(KEY), message)
  };
